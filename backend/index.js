...
app.post('/AgregarCategoria', (req, res) => {
    ...
    if (!validador.validarDatos(nombreCategoria) || !validador.validarDatos(descripcion)) {
        resp.status = 400;
    ...
    servicioCategoria.agregarCategoria(nombreCategoria, descripcion)
        .then(data => {
...
app.put('/ActualizarCategoria/:idCategoria', (req, res) => {
    ...
    if (!validador.validarDatos(nombreCategoria) || !validador.validarDatos(descripcion) || !validador.validarDatos(idCategoria)) {
        resp.status = 400;
    ...
    servicioCategoria.actualizarCategoria(nombreCategoria, descripcion, idCategoria)
        .then(data => {
            resp.mensaje = mensaje.mensajeOK;
            res.set({
                "Context-type": "Text/json"
...
app.post('/AgregarComentario', (req, res) => {
    ...
    if (!validador.validarDatos(comentario) || !validador.validarDatos(calificacion) ||
        !validador.validarDatos(fecha) || !validador.validarDatos(usuario) || 
        !validador.validarDatos(codigoAplicacion)) {
        resp.status = 400;
        resp.mensaje = mensaje.MensajeValidador;
    ...
    servicioComentario.agregarComentario(comentario, calificacion, fecha, usuario, codigoAplicacion)
        .then(data => {
            resp.mensaje = mensaje.mensajeOK;
            res.set({
                "Context-type": "Text/json"
...
app.put('/ActualizarComentario/:idImagen', (req, res) => {
    ...
    if (!validador.validarDatos(comentario) || !validador.validarDatos(calificacion) ||
        !validador.validarDatos(fecha) || !validador.validarDatos(usuario) || 
        !validador.validarDatos(codigoAplicacion) || !validador.validarDatos(idImagen)) {
        resp.status = 400;
        resp.mensaje = mensajes.MensajeValidador
    ...
    servicioComentario.actualizarComentario(comentario, calificacion, fecha, usuario, codigoAplicacion, idImagen)
        .then(data => {
            resp.mensaje = mensaje.mensajeOK;
            res.set({
                "Context-type": "Text/json"
...
app.post('/AgregarAplicacion', (req, res) => {
    ...
    let instalada = req.body.instalada;
    ...
    servicioAplicacion.agregarAplicacion(nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria)
        .then(data => {
            resp.mensaje = mensaje.mensajeOK;
            res.set({
                "Context-type": "Text/json"
 ...
 */
    ...
    servicioAplicacion.actualizarAplicacion(nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria, codigo)
        .then(data => {
            resp.mensaje = mensaje.mensajeOK;
            res.set({
                "Context-type": "Text/json"
...
app.get('/CatalogoCategoria/:idCategoria', (req, res) => {
    ...
    servicioCategoria.SeleccionarCategoriaById(idCategoria)
        .then(data => {
            ...
            catalogo[0].nombreCategoria = data[0].nombreCategoria;
