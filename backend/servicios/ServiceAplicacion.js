...
function agregarAplicacion(nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria) {
    return new Promise((resolve, reject) => {
        conexion.query(consulta.insertAplicacion, [nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria], (error, resultado) => {
            if (error) {
                reject(error)
            } else {
                resolve(resultado)
...
function actualizarAplicacion(nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria, codigo) {

    return new Promise((resolve, reject) => {
        conexion.query(consulta.updateAplicacion, [nombre, precio, descripcion, icono, instalada, app, calificacion, descargas, desarrollador, idCategoria, codigo], (error, resultado) => {
